...
public class PracticaSetmana2ApplicationTests {
     ...
     */
    /**
     * Creau un controlador al package org.formacio.mvc que respongui a les
     * peticions que s'especifiquen als seguents tests. El controlador ha de fer
     * us de AgendaService
     */
    /**
     * a la peticio /nombre ha de respondre amb el nombre de contactes (obtingut
     * de AgendaService)
     */
    @Test
    ...
    /**
     * A la peticio /telefon?id=xx ha de respondre amb el telefon del contacte
     * amb id passat com a paràmetre (xx)
     */
    @Test
    ...
    /**
     * A la peticio /contacte/id ha de respondre amb l'objecte Persona
     * corresponent al identificador id (forma part de la url)
     *
    ...
    /**
     * Customitzau la conversio de Persona a json per a que la propietat nom de
     * Persona surti com a contacte a json
     */
    @Test
    ...
    /**
     * Feis, sense espatllar res del que s'ha fet anteriorment, que la si l'id
     * no existeix, retorni un 404
     */
    @Test
    ...
    /**
     * A la peticio POST /afegir amb parametres id, nom i telefon se ha de crear
     * una nova entrada al repositori
     *
     */
    @Test
    ...
    /**
     * Crea un controlador /grupos que devuelva un listado con los nombres de
     * los grupos
     *
     */
    @Test
